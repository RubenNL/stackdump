This is imported from https://bitbucket.org/samuel.lai/stackdump/src. the original author didn't update his code.
...
(the urls are broken, but kept for future reference)
...
*6gb isn't even enough. use the scripts "here":https://github.com/RubenNL/stackdump-lowram to import stackoverflow, if you don't have around 64gb of ram.*
...
h3. Reports on importing the StackOverflow data dump, Januari 2020

Don't try importing stackoverflow without using "stackdump-lowram":https://github.com/RubenNL/stackdump-lowram . It won't work.
